...
class AllJobs extends Component {
  ...
  // This function will render the user profile details whenever the loads
  ...
  // This function will render the all jobs details
  ...
  // This function changes the radioInput value inthe state

  onGetRadioOption = event => {
    this.setState({radioInput: event.target.id}, this.onGetJobDetails)
  }

  // This function changes the chackbox value in the state whenever the user clicks on a checkbox
  ...
  // The below code shows user Profile details
  ...
  // If somethign went wrong while fetching the userDetails i added a retry function wheneve user clicks on that it will refresh the page
  onRetryProfile = () => {
    this.onGetProfileDetails()
  }
